...
class InterfaceSingleton(metaclass=InterfaceMeta):
    ...
    def show_text(self, text):
        ...
        self.text_box_over_image.tag_config(interface_translations["interface_life"][self.lang], foreground=vita_color)
        self.text_box_over_image.tag_config(interface_translations["interface_strenght"][self.lang], foreground=forza_color)
        self.text_box_over_image.tag_config(interface_translations["interface_mana"][self.lang], foreground=mana_color)
        self.text_box_over_image.tag_config(interface_translations["interface_gold"][self.lang], foreground=oro_color)

        self.text_box_over_image.insert(tk.END, interface_translations["interface_life"][self.lang]+": {} ".format(pg.PG.PV), interface_translations["interface_life"][self.lang])
        self.text_box_over_image.insert(tk.END, "| ")
        self.text_box_over_image.insert(tk.END, interface_translations["interface_strenght"][self.lang]+": {} ".format(pg.PG.PF), interface_translations["interface_strenght"][self.lang])
        self.text_box_over_image.insert(tk.END, "| ")
        self.text_box_over_image.insert(tk.END, interface_translations["interface_mana"][self.lang]+": {} ".format(pg.PG.PM), interface_translations["interface_mana"][self.lang])
        self.text_box_over_image.insert(tk.END, "| ")
        self.text_box_over_image.insert(tk.END, interface_translations["interface_gold"][self.lang]+": {} ".format(pg.PG.g), interface_translations["interface_gold"][self.lang])
        self.text_box_over_image.insert(tk.END, "|| ")
        inventory_str = '|'.join(str(item) for item in pg.PG.inventory)
        self.text_box_over_image.insert(tk.END, interface_translations["pg_invetory"][self.lang]+": {} ".format(inventory_str))
        self.text_box_over_image.insert(tk.END, "\n----------------------------------------------------------------------------"
                                        "-----------------------")
