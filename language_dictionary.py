...
level_translations = {
        ...
        "l1_34":                {"en":"As you open the door, a foul stench\n of decay hits your senses. You \nfind yourself in a large room\n with a majestic staircase \nrising upwards. The walls are \ndecorated with enigmatic \nsymbols, and dim lights\ncast eerie shadows.",
                                 "it":"Aperta la porta un'immondo fetore \ndi putrefazione colpisce i tuoi\nsensi, ti trovi in una grande \nstanza con una maestosa scala \nche si innalza verso l'alto. \nLe pareti sono decorate con \nsimboli enigmatici e le luci \nfioche gettano ombre inquietanti."},
...
actions_translations = {
    ...
    "go-east":              {"it": "Vai a Est",                                         "en": "Go East"},
    "go-west":              {"it": "Vai a Ovest",                                       "en": "Go West"},
    "pickup-key":           {"it": "Raccogli la chiave",                                "en": "Pick up the key"},
    "no-key" :              {"it":"Non hai la chiave.",                                 "en": "You don't have the key."},
    ...
    "l1_05-06":             {"it": "Entra nella porta ad Est",                          "en": "Enter the East door"},
...
callbacks_translations = {
    ...
    "l1_34fight" :          {"it":"\n\n---------------------------------\n\nIncredulo osservi le orbite vuote \ndi un cadavere mentre lui, \ncon movimenti innaturali, \navanza inesorabile verso te.",
